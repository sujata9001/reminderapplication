...
<section class="my-5">
	...
	<div class="container w-50 m-auto">
	  <form action="modifyOperation.jsp" method="POST">
	  ...
	  <%
		...
		PreparedStatement pst = con.prepareStatement("select * from setreminders where rid = ?");
		...
		<div class="form-group">
		  ...
		  <input type="date" class="form-control"placeholder="Set a Date" value="<%= rs.getString("setdate")%>" name="setdate" required >
		</div>
		<div class="form-group">
			...
			<select name="subject" class="selectpicker">
			  ...
			  <option value="options2">option2</option>
			  <option value="options3">optioin3</option>
			</select>
        </div>
		<div class="form-group">
		...
		<div class="form-group">
		  ...
		  <input type="email" class="form-control" id="email" placeholder="Email" value="<%= rs.getString("email")%>" name="email" required>
        </div>
		<div class="form-group">
		  <label for="mobileno">Contact number</label>
		  <input type="number" class="form-control" id="contactno" placeholder="Enter contect number" value="<%= rs.getString("contactno")%>" name="contactno" required>
		</div>
		<div class="form-group">
		  <label for="smsno">SMS number</label>
		  <input type="number" class="form-control" id="smsno" placeholder="Enter SMS number" value="<%= rs.getString("smsno")%>" name="smsno" required>
		</div>
